...
<a href="#" class="back_menu" style="display:none">&nbsp;</a>
    ...
    <!--<div id="iframediv" class="iframediv" style="position:absolute;  width:100%; z-index:9000">
      <iframe src="<?php echo base_path();?>slidemenu-ta.php" frameborder="0"  seamless="seamless" scrolling="no"  allowtransparency="true"></iframe>
    </div>-->
...
<img src="<?php print base_path().path_to_theme()?>/images/cont_hd.jpg" alt="" title="">
   ...
   <div class="ifm"> 
    <iframe class="frm" id="frm" src="<?php echo base_path();?>livesearch-ta.php" width="445"  frameborder="0" allowtransparency="0" scrolling="no">
